...
Understand the complete ASIC Physical Design flow and the different stages involved in converting a design into a physical layout.

Learn the fundamentals of floorplanning and power planning for efficient area utilization and reliable power distribution.

Study placement techniques and Clock Tree Synthesis (CTS) for better cell arrangement and balanced clock distribution.

Understand routing and antenna effects, along with their impact on physical design quality and reliability.

Explore Static Timing Analysis (STA) and parasitic extraction to evaluate timing performance and interconnect effects.

Learn the concepts of DRC and LVS for checking layout correctness and design connectivity.

Understand the role of OpenLane, OpenROAD, and the SKY130 PDK in the open-source ASIC design flow.

Analyze important physical-design metrics such as area, utilization, timing, congestion, and routability.
...
**🗺️ From RTL to Silicon — My Physical Design Learning Path**

Physical Design Journey — Module Roadmap
...
🔹 04 — Clock Tree Synthesis

🔹 05 — Routing

🔍 Design Checks & Optimization

🔹 06 — Antenna Rule Checking

🔹 07 — Antenna Violation Repair

🔹 08 — Static Timing Analysis

🔹 09 — Parasitic Extraction

🔹 10 — Logic Equivalence Check

🔹 11 — Physical Verification

⚙️ Open-Source ASIC Flow

🔹 12 — OpenLane Design Exploration

🔹 13 — OpenLane ASIC Flow

🔹 14 — OpenLane & OpenROAD
...
🔹 26 — Terminal Execution & Command Evidence
...
<img width="1280" height="590" alt="WhatsApp Image 2026-09-06 at 7 47 13 PM" src="https://github.com/user-attachments/assets/0b98eb6f-b109-4b2d-ab54-ede43f0e41aa" />
...
# 2️⃣6️⃣. Terminal Execution and Command Evidence
...
This project offered hands-on experience with the ASIC Physical Design process using OpenLane and the SKY130 PDK. It helped in understanding the key stages involved in transforming a synthesized design into a physical chip layout.

Through the implementation, the importance of floorplanning, power planning, placement, CTS, routing, timing analysis, and physical verification was explored. It also highlighted how design parameters influence area, timing, utilization, congestion, and overall performance.

Overall, the project strengthened the understanding of the RTL-to-GDSII flow and demonstrated how open-source EDA tools can be effectively used for practical VLSI physical design and ASIC implementation.
